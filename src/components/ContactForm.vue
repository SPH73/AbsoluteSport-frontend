    ...
    <div class="container">
      <base-card>
        <div class="container">
          ...
          <p class="text-light">
            Please feel free to contact us if you have any questions and we will
            respond
            within one business day. We would love to hear from you!
          </p>
        </div>
        <div class="container">
            ...
            <div class="grid-inputs">
              <div class="form-control" :class="{
                ...
                <input type="text" placeholder="Your name"
                       v-model="enteredName.val" autocomplete="name" required />
              </div>
              <div class="form-control" :class="{
                invalid: !enteredEmail.isValid,
              }">
                <input type="email" placeholder="Your email"
                       v-model="enteredEmail.val" autocomplete="email"
                       required />
              </div>
              <div class="form-control-textarea" :class="{
                invalid: !enteredMessage.isValid,
              }">
                <textarea placeholder="How can we help?"
                          v-model="enteredMessage.val" required></textarea>
              </div>
            </div>
...
//   const data = {
//     solution: document.getElementsByClassName(".frc-captcha-solution").value,
//     secret: apikey,
//     sitekey: sitekey,
//   };
