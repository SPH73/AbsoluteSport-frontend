  ...
  <header class="header">
    <div>
      <router-link :to="{ name: 'home' }" class="header-logo"
        ><img src="@/assets/logo.webp" alt="AbsoluteSport" class="header-logo"
      /></router-link>
    </div>
    <TheNavbarMobile :class="{ open: showNav }" :toggleShowNav="toggleShowNav" />
    <div id="nav-menu-icon" v-if="mobileView">
      <img @click.self="toggleShowNav" src="@/assets/menu-icon.svg" alt="menu" />
    </div>
