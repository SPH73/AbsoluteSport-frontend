    ...
    <main>
            ...
            <div class="container">
                ...
                <div v-if="faqList.length">
                    ...
                    <div v-if="selectedTag" id="selected-tag">
                        <p class="center">
                            Searching all Faq's tagged with #{{
                                selectedTag
                            }}&nbsp;
                            <base-button class="trash" @click="clearTag"
                                >&#128465;</base-button
                            >
                        </p>
                    </div>
                ...
                <div class="btn-group">
                    <base-button class="btn" @click="clearFilters">
                        Clear All
                    </base-button>
                    <base-button
                        class="btn"
                    ...
                    <base-button class="btn" v-else @click="showFaqList">
                        Show All
                    </base-button>
                </div>
            </div>
        ...
        <section class="section faqs">
            ...
            <transition name="showFiltered">
                <div v-if="selectedTag" class="section tag">
                    <div class="container" id="search-tag">
                        ...
                        <div v-else>
                            <p>
                                Oops! We seem to be having a problem searching
                                that tag...
                            </p>
                        </div>
                    </div>
                ...
                <div v-else-if="search.length">
                    ...
                    <div v-else>
                        <p>
                            Try a typing a different search term or phrase or
                            use search by tag...
                        </p>
                    </div>
                </div>
            ...
            <transition name="showFaq">
                <div
                    v-if="showFaqs && !search.length && !selectedTag"
...
export default {
    name: 'faqs',
    components: { FAQList, TagCloud, Spinner, InputSearch, TagSearch },
    setup() {
        ...
        const matchingFAQ = computed(() => {
            return faqList.value.filter(faq =>
                faq.question.includes(search.value),
            );
        });
        const showFaqList = () => {
            showFaqs.value = true;
        ...
        const filteredFAQs = computed(() => {
            return faqList.value.filter(faq =>
                faq.tags.includes(selectedTag.value),
            );
        });
