  ...
  <main>
          ...
          <div class="container">
            <base-card>
              ...
              <div v-if="clubSection">
                <template v-for="el in clubSection" :key="el.id">
          ...
          <div class="container">
            <base-card>
              ...
              <div v-if="campSection">
                <template v-for="el in campSection" :key="el.id">
          ...
          <div class="container">
            <base-card>
              ...
              <div v-if="partySection">
                <template v-for="el in partySection" :key="el.id">
    ...
    <section class="section about">
      <div class="container">
        ...
        <h3>
          Service Provider to Parents, Schools, Councils and Sport Coaches in West Sussex
          and Hampshire
        </h3>
        <p>
          Whether you're a parent seeking ways to help your children become more active or
          a school or other organisation looking for a provider of first-class sports
          coaching, mentoring or training, AbsoluteSport is certified to help.
        </p>
        <p>
          Our highly qualified and experienced team will provide programmes and activities
          tailored to your exact needs.
        </p>
        <p>
          Our mission is to engage children and young people in physical activity, by
          providing innovative delivery and training services and the resources to educate
          and inspire.
        </p>
...
load();
const { homepageContent, homepageError, loadHomepageContent } = getHomepageContent();
loadHomepageContent();
// console.log('Homepage content', homepageContent.value);

// segment content
const partySection = computed(() =>
  homepageContent.value.filter((content) => content.section === "party")
);
