        ...
        <section class="section">
                ...
                <div v-if="partyList.length">
                    <div v-if="selectedParty">
                        <div class="party-content">
                            ...
                            <div
                                v-for="p in selectedParty.descriptionBody"
                                :key="p"
                            >
            ...
            <div class="container">
                <div class="btn-group">
                    ...
                    >
                        <base-button
                            >AbsoluteSport<span>&nbsp;⟼</span></base-button
                        >
                    </router-link>
                    <router-link
                        :class="{ hide: isActive }"
                    ...
                    >
                        <base-button
                            >Football Frenzy<span>&nbsp;⟼</span></base-button
                        >
                    </router-link>
                    <router-link
                        :class="{ hide: isActive }"
...
export default {
    ...
    setup(props) {
        ...
        const loadParty = propsId => {
            selectedParty.value = partyList.value.find(
                party => party.id === propsId.value,
            );
        };
        loadParty(propsId);
